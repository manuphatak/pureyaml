...
def test_travis_yml__literal_key():
    text = dedent("""
        ...
        deploy:
          ...
          password:
            secure: >
              
          provider: pypi
          user: bionikspoon
    ...
    actual = load(text)
    actual['deploy']['password']['secure'] = actual['deploy']['password']['secure'].replace(' ', '')

    assert actual['deploy']['password']['secure'] == expected['deploy']['password']['secure'] == secure_block
    # assert actual == expected
