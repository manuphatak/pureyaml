...
_lr_productions = [
  ...
  ('docs -> doc','docs',1,'p_docs__last','rules.py',399),
  ('docs -> docs doc','docs',2,'p_docs__init','rules.py',406),
  ('doc -> DOC_START doc DOC_END','doc',3,'p_doc__indent','rules.py',413),
  ('doc -> DOC_START doc','doc',2,'p_doc__indent','rules.py',414),
  ('doc -> INDENT doc DEDENT','doc',3,'p_doc__indent','rules.py',415),
  ('doc -> collection','doc',1,'p_doc','rules.py',422),
  ('doc -> scalar','doc',1,'p_doc','rules.py',423),
  ('collection -> sequence','collection',1,'p_collection','rules.py',430),
  ('collection -> map','collection',1,'p_collection','rules.py',431),
  ('collection -> flow_collection','collection',1,'p_collection','rules.py',432),
  ('map -> map_item','map',1,'p_map__last','rules.py',439),
  ('map -> map map_item','map',2,'p_map__init','rules.py',446),
  ('map_item -> map_item_key map_item_value','map_item',2,'p_map_item','rules.py',453),
  ('map_item -> B_MAP_COMPACT_KEY scalar B_MAP_VALUE scalar DEDENT','map_item',5,'p_map_item__compact_scalar','rules.py',460),
  ('map_item_key -> B_MAP_KEY scalar','map_item_key',2,'p_map_item_key__complex_key_scalar','rules.py',467),
  ('map_item_key -> scalar','map_item_key',1,'p_map_item_key','rules.py',474),
  ('map_item_key -> B_MAP_KEY INDENT collection DEDENT','map_item_key',4,'p_map_item___key_value__collection','rules.py',481),
  ('map_item_value -> B_MAP_VALUE INDENT collection DEDENT','map_item_value',4,'p_map_item___key_value__collection','rules.py',482),
  ('map_item_value -> B_MAP_VALUE flow_collection','map_item_value',2,'p_map_item_value__flow_collection','rules.py',489),
  ('map_item_value -> B_MAP_VALUE scalar','map_item_value',2,'p_map_item_value__scalar','rules.py',496),
  ('sequence -> sequence_item','sequence',1,'p_sequence__last','rules.py',510),
  ('sequence -> sequence sequence_item','sequence',2,'p_sequence__init','rules.py',517),
  ('sequence_item -> B_SEQUENCE_START scalar','sequence_item',2,'p_sequence_item__scalar','rules.py',524),
  ('sequence_item -> B_SEQUENCE_START INDENT collection DEDENT','sequence_item',4,'p_sequence_item__collection','rules.py',538),
  ('map_item_key -> B_MAP_COMPACT_KEY collection DEDENT','map_item_key',3,'p_map_item__key__map_item_value__sequence_item__compact_collection','rules.py',545),
  ('map_item_value -> B_MAP_COMPACT_VALUE collection DEDENT','map_item_value',3,'p_map_item__key__map_item_value__sequence_item__compact_collection','rules.py',546),
  ('sequence_item -> B_SEQUENCE_COMPACT_START collection DEDENT','sequence_item',3,'p_map_item__key__map_item_value__sequence_item__compact_collection','rules.py',547),
  ('sequence_item -> B_SEQUENCE_START flow_collection','sequence_item',2,'p_sequence_item__flow_collection','rules.py',554),
  ('scalar -> DOUBLEQUOTE_START SCALAR DOUBLEQUOTE_END','scalar',3,'p_scalar__doublequote','rules.py',561),
  ('scalar -> SINGLEQUOTE_START SCALAR SINGLEQUOTE_END','scalar',3,'p_scalar__singlequote','rules.py',569),
  ('scalar -> DOUBLEQUOTE_START DOUBLEQUOTE_END','scalar',2,'p_scalar__quote_empty','rules.py',576),
  ('scalar -> SINGLEQUOTE_START SINGLEQUOTE_END','scalar',2,'p_scalar__quote_empty','rules.py',577),
  ('scalar -> CAST_TYPE scalar','scalar',2,'p_scalar__explicit_cast','rules.py',584),
  ('scalar -> SCALAR','scalar',1,'p_scalar','rules.py',591),
  ('scalar -> B_LITERAL_START scalar_group B_LITERAL_END','scalar',3,'p_scalar__literal','rules.py',598),
  ('scalar -> B_FOLD_START scalar_group B_FOLD_END','scalar',3,'p_scalar__folded','rules.py',606),
  ('scalar -> INDENT scalar_group DEDENT','scalar',3,'p_scalar__indented_flow','rules.py',615),
  ('scalar_group -> SCALAR','scalar_group',1,'p_scalar_group','rules.py',624),
  ('scalar_group -> scalar_group SCALAR','scalar_group',2,'p_scalar_group','rules.py',625),
  ('flow_collection -> F_SEQUENCE_START flow_sequence F_SEQUENCE_END','flow_collection',3,'p_flow_collection','rules.py',636),
  ('flow_collection -> F_MAP_START flow_map F_MAP_END','flow_collection',3,'p_flow_collection','rules.py',637),
  ('flow_sequence -> flow_sequence_item','flow_sequence',1,'p_flow_sequence__last','rules.py',644),
  ('flow_sequence -> flow_sequence F_SEP flow_sequence_item','flow_sequence',3,'p_flow_sequence__init','rules.py',651),
  ('flow_sequence_item -> scalar','flow_sequence_item',1,'p_flow_sequence_item','rules.py',658),
  ('flow_map -> flow_map_item','flow_map',1,'p_flow_map__last','rules.py',665),
  ('flow_map -> flow_map F_SEP flow_map_item','flow_map',3,'p_flow_map__init','rules.py',672),
  ('flow_map_item -> flow_map_item_key flow_map_item_value','flow_map_item',2,'p_flow_map_item','rules.py',679),
  ('flow_map_item_key -> scalar F_MAP_KEY','flow_map_item_key',2,'p_flow_map_item_key','rules.py',686),
  ('flow_map_item_value -> scalar','flow_map_item_value',1,'p_flow_map_item_value','rules.py',693),
]
