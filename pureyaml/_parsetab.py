...
_lr_productions = [
  ...
  ('docs -> doc','docs',1,'p_docs_last','grammar.py',338),
  ('docs -> docs doc','docs',2,'p_docs_init','grammar.py',345),
  ('doc -> DOC_START doc DOC_END','doc',3,'p_doc_indent','grammar.py',352),
  ('doc -> DOC_START doc','doc',2,'p_doc_indent','grammar.py',353),
  ('doc -> INDENT doc DEDENT','doc',3,'p_doc_indent','grammar.py',354),
  ('doc -> collection','doc',1,'p_doc','grammar.py',361),
  ('doc -> scalar','doc',1,'p_doc','grammar.py',362),
  ('collection -> sequence','collection',1,'p_collection','grammar.py',369),
  ('collection -> map','collection',1,'p_collection','grammar.py',370),
  ('collection -> flow_collection','collection',1,'p_collection','grammar.py',371),
  ('map -> map_item','map',1,'p_map_last','grammar.py',378),
  ('map -> map map_item','map',2,'p_map_init','grammar.py',385),
  ('map_item -> map_item_key map_item_value','map_item',2,'p_map_item','grammar.py',392),
  ('map_item_key -> scalar','map_item_key',1,'p_map_item_key','grammar.py',399),
  ('map_item_value -> B_MAP_VALUE INDENT collection DEDENT','map_item_value',4,'p_map_item_value_collection','grammar.py',406),
  ('map_item_value -> B_MAP_VALUE flow_collection','map_item_value',2,'p_map_item_value_flow_collection','grammar.py',413),
  ('map_item_value -> B_MAP_VALUE scalar','map_item_value',2,'p_map_item_value_scalar','grammar.py',420),
  ('sequence -> sequence_item','sequence',1,'p_sequence_last','grammar.py',434),
  ('sequence -> sequence sequence_item','sequence',2,'p_sequence_init','grammar.py',441),
  ('sequence_item -> B_SEQUENCE_START scalar','sequence_item',2,'p_sequence_item_scalar','grammar.py',448),
  ('sequence_item -> B_SEQUENCE_START INDENT collection DEDENT','sequence_item',4,'p_sequence_item_collection','grammar.py',462),
  ('sequence_item -> B_SEQUENCE_COMPACT_START collection DEDENT','sequence_item',3,'p_sequence_item_compact_collection','grammar.py',469),
  ('sequence_item -> B_SEQUENCE_START flow_collection','sequence_item',2,'p_sequence_item_flow_collection','grammar.py',476),
  ('scalar -> DOUBLEQUOTE_START SCALAR DOUBLEQUOTE_END','scalar',3,'p_scalar_doublequote','grammar.py',483),
  ('scalar -> SINGLEQUOTE_START SCALAR SINGLEQUOTE_END','scalar',3,'p_scalar_singlequote','grammar.py',491),
  ('scalar -> DOUBLEQUOTE_START DOUBLEQUOTE_END','scalar',2,'p_scalar_quote_empty','grammar.py',498),
  ('scalar -> SINGLEQUOTE_START SINGLEQUOTE_END','scalar',2,'p_scalar_quote_empty','grammar.py',499),
  ('scalar -> CAST_TYPE scalar','scalar',2,'p_scalar_explicit_cast','grammar.py',506),
  ('scalar -> SCALAR','scalar',1,'p_scalar','grammar.py',513),
  ('scalar -> B_LITERAL_START scalar_group B_LITERAL_END','scalar',3,'p_scalar_literal','grammar.py',520),
  ('scalar -> B_FOLD_START scalar_group B_FOLD_END','scalar',3,'p_scalar_folded','grammar.py',528),
  ('scalar -> INDENT scalar_group DEDENT','scalar',3,'p_scalar_indented_flow','grammar.py',537),
  ('scalar_group -> SCALAR','scalar_group',1,'p_scalar_group','grammar.py',546),
  ('scalar_group -> scalar_group SCALAR','scalar_group',2,'p_scalar_group','grammar.py',547),
  ('flow_collection -> F_SEQUENCE_START flow_sequence F_SEQUENCE_END','flow_collection',3,'p_flow_collection','grammar.py',558),
  ('flow_collection -> F_MAP_START flow_map F_MAP_END','flow_collection',3,'p_flow_collection','grammar.py',559),
  ('flow_sequence -> flow_sequence_item','flow_sequence',1,'p_flow_sequence_last','grammar.py',566),
  ('flow_sequence -> flow_sequence F_SEP flow_sequence_item','flow_sequence',3,'p_flow_sequence_init','grammar.py',573),
  ('flow_sequence_item -> scalar','flow_sequence_item',1,'p_flow_sequence_item','grammar.py',580),
  ('flow_map -> flow_map_item','flow_map',1,'p_flow_map_last','grammar.py',587),
  ('flow_map -> flow_map F_SEP flow_map_item','flow_map',3,'p_flow_map_init','grammar.py',594),
  ('flow_map_item -> flow_map_item_key flow_map_item_value','flow_map_item',2,'p_flow_map_item','grammar.py',601),
  ('flow_map_item_key -> scalar F_MAP_KEY','flow_map_item_key',2,'p_flow_map_item_key','grammar.py',608),
  ('flow_map_item_value -> scalar','flow_map_item_value',1,'p_flow_map_item_value','grammar.py',615),
  ('empty -> <empty>','empty',0,'p_empty','grammar.py',621),
]
